...
<div class="content-side content-side-user px-0 py-0">
  ...
  <div class="content-side content-side-full">
    <ul class="nav-main">
      ...
      <li class="nav-main-item">
        <a class="nav-main-link  {{ $route == 'data_plans.index' ? 'active' : '' }}" href="{{ route('data_plans.index') }}">
          <i class="nav-main-link-icon fas fa-database"></i>
          <span class="nav-main-link-name">Data Plans</span>
        </a>
      </li>
      <li class="nav-main-item">
        <a class="nav-main-link  {{ $route == 'plan-providers.index' ? 'active' : '' }}" href="{{ route('plan-providers.index') }}">
          <i class="nav-main-link-icon fas fa-network-wired"></i>
          <span class="nav-main-link-name">Plan Providers</span>
        </a>
      </li>
        ...
        <ul class="nav-main-submenu">
          ...
          <li class="nav-main-item">
            <a class="nav-main-link  {{ $route == 'charges' ? 'active' : '' }}" href="{{ route('charges') }}">
              <span class="nav-main-link-name">Main Settings</span>
            </a>
          </li>
          <li class="nav-main-item">
