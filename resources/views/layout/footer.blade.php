    ...
    <div class="container px-0">
      ...
      <div class="footer-nav position-relative">
        <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
          <li class="{{ $route == 'regular.home' ? 'active' : '' }}"><a href="{{ route('regular.home') }}">
          ...
          <li class="{{ $route == 'contacts.index' ? 'active' : '' }}"><a href="{{ route('contacts.index') }}">
              ...
              </svg><span>Beneficiaries</span></a></li>
          <li class="{{ $route == 'wallet.index' ? 'active' : '' }}"><a href="{{ route('wallet.index') }}">
          ...
          <li class="{{ $route == 'chat.index' ? 'active' : '' }}"><a href="{{ route('chat.index') }}">
              ...
              </svg><span>Chat AI</span></a></li>
          <li class="{{ $route == 'account.index' ? 'active' : '' }}"><a href="{{ route('account.index') }}">
