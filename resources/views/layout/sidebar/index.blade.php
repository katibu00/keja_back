    ...
    <div class="offcanvas-body p-0">
      ...
      <div class="sidenav-wrapper">
        ...
        <div class="sidenav-profile bg-gradient">
          ...
          <!-- User Thumbnail -->
          <div class="user-profile"><img src="/frontend/img/bg-img/2.jpg" alt=""></div>
          <!-- User Info -->
          <div class="user-info">
        ...
        <ul class="sidenav-nav ps-0">
          ...
          <li><a href="/frontend/settings.html"><i class="bi bi-gear"></i>Settings</a></li>
          <li>
        ...
        <!-- Social Info -->
        <div class="social-info-wrap"><a href="/frontend/#"><i class="bi bi-facebook"></i></a><a href="/frontend/#"><i class="bi bi-twitter"></i></a><a href="/frontend/#"><i class="bi bi-linkedin"></i></a></div>
        <!-- Copyright Info -->
        <div class="copyright-info">
          <p>2021 &copy; Made by<a href="#">SubNow Communications Ltd</a></p>
        </div>
      </div>
    </div>
  </div>